...
try:
    from downloader_original import run_download, load_config, save_config
except ImportError:
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # ── Tạm thời comment bộ lọc Sàn giao dịch ──────────────────────────
    ...
    def start_download(self):
        ...
        self.downloaded_count = 0
        self.completed_tasks = 0
        from downloader_original import generate_monthly_intervals
