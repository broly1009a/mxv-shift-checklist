...
async function main() {
  const baseDir = 'c:\\Users\\hiepth\\OneDrive - MERCANTILE EXCHANGE OF VIETNAM\\Documents\\Github\\mxv-shift-checklist\\Marco thong ke lot\\root';
  const files = [
    ...
    { name: 'Thong ke so lot giao dich Options 2026 root.xlsx', label: 'Options' },
    { name: 'Thong ke so lot giao dich Spread 2026 root.xlsx', label: 'Spread' },
  ];
