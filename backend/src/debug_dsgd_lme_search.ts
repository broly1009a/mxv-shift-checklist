...
async function main() {
  const dsgdPath = 'c:\\Users\\hiepth\\OneDrive - MERCANTILE EXCHANGE OF VIETNAM\\Documents\\Github\\mxv-shift-checklist\\Marco thong ke lot\\Backup MS\\16.07\\DSGD.xlsx';
  ...
  const matched = sheet.rows.filter((r: any) => {
    return Object.values(r).some(val => {
      ...
      return s.includes('041C0888668') || s.includes('LTIZ') || s.includes('041C0888668-L');
    });
  });
