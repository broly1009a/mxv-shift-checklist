...
async function main() {
  ...
  for (let r = 11; r <= 77; r++) {
    ...
    console.log(`L${r} (Label ${getCellDetails(cellK)}): ${getCellDetails(cellL)}`);
  }
  ...
  for (let r = 12; r <= 20; r++) {
    ...
    console.log(`N${r} (Label ${getCellDetails(cellM)}): ${getCellDetails(cellN)}`);
  }
  ...
  for (let r = 11; r <= 13; r++) {
    ...
    console.log(`T${r} (Label ${getCellDetails(cellS)}): ${getCellDetails(cellT)}`);
  }
}
