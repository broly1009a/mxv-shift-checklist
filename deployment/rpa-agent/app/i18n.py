...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    # ── Guide tab ─────────────────────────────────────────────────────────────
    "guide_setup_title":    {"vi": "⚙️  Thiết lập lần đầu",   "en": "⚙️  Initial Setup"},
    ...
    "guide_tray_title":     {"vi": "🖥️  Biểu tượng góc màn hình (góc dưới bên phải)",
                             "en": "🖥️  System Tray Icon (bottom-right corner)"},
