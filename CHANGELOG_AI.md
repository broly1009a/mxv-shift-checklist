...
- **Sửa đổi**:
  ...
  - [templates/page.tsx](file:///c:/Users/hiepth/OneDrive%20-%20MERCANTILE%20EXCHANGE%20OF%20VIETNAM/Documents/Github/mxv-shift-checklist/frontend/src/app/admin/templates/page.tsx): Điều chỉnh kích thước của hai nút phụ là **"Sửa thông tin mẫu"** và **"Xóa mẫu"** (thu nhỏ padding từ `12px 20px` xuống `8px 14px`, chiều cao cố định `36px`, cỡ chữ `0.82rem`, icon kích thước `14px`) nhằm tạo sự phân định rõ ràng giữa các hành động quản lý chi tiết trong mẫu và các hành động chính toàn trang, giúp bố cục thẻ hiển thị gọn gàng và tinh tế hơn.
